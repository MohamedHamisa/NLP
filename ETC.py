...
# defines a distributed command line system, replacing systems like getopt() , optparse , and manual argument processing 
# Rather than an application having to define all flags in or near main() , each Python module defines flags that are useful to it

from absl import flags
import numpy as np
import tensorflow.compat.v1 as tf
from tensorflow.compat.v1 import estimator as tf_estimator #compat allows you to write code that works both in TensorFlow 1 and to evaluate it
