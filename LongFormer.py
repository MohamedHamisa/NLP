    ...
    def forward(
        ...
        if attention_mask is not None:
            ...
            if max_num_extra_indices_per_batch <= 0:
                ...
                selection_padding_mask = zero_to_max_range < num_extra_indices_per_batch.unsqueeze(dim=-1) #Returns a new tensor with a dimension of size one inserted at the specified position.
        ...
        if extra_attention_mask is not None:
            ...
            # attn = torch.einsum('blhs,bshd->blhd', (selected_attn_probs, selected_v)) #einsum  allows computing many common multi-dimensional linear algebraic array
